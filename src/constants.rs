...
pub const BOX_DIM : Vec2 = Vec2::new(30., 30.);
pub const BOX_PADDING_MIN : Vec2 = Vec2::new(5., 5.);
pub const BOX_PADDING_MAX : Vec2 = Vec2::new(5., 5.);
pub const WINDOW_PADDING : Vec2 = Vec2::new(20.0, BOX_PADDING_MIN.y);
pub const SIDEBAR_LEFT_WIDTH : f32 = 30.0;
pub const BOX_DESELECTED_COLOR : egui::Color32 = egui::Color32::from_rgb(66, 66, 66);
pub const BOX_CURSORED_COLOR : egui::Color32 = egui::Color32::from_rgb(100, 100, 100);
...
pub const FONT_SIZE_NOTE : f32 = 15.0;
